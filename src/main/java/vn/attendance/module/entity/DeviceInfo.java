package vn.attendance.module.entity;

import com.sun.jna.Pointer;
import vn.attendance.lib.NetSDKLib;
import vn.attendance.lib.enumeration.EMDeviceType;
...
public class DeviceInfo {
     ...
     * 该参数只适用于{@link vn.attendance.module.BaseModule#loginEx2(String, int, String, String, int, Pointer)}和
     * {@link vn.attendance.module.BaseModule#loginWithHighSecurity(String, int, String, String, int, Pointer)} (String, int, String, String, int, Structure, NetSDKLib.NET_DEVICEINFO_Ex)}
     */
