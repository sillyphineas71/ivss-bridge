...
import vn.attendance.lib.structure.DEV_EVENT_SECURITYGATE_PERSONALARM_INFO;
import vn.attendance.lib.structure.NET_SECURITYGATE_ALARM_FACE_INFO;
    ...
    public int invoke(NetSDKLib.LLong lAnalyzerHandle, int dwAlarmType, Pointer pAlarmInfo, Pointer pBuffer,
        ...
        switch(dwAlarmType)
        {
            case NetSDKLib.EVENT_IVS_SECURITYGATE_PERSONALARM:  //安检门人员报警事件
            {
                ...
                /**
                 *  人员通过方向枚举,参考枚举{@link vn.attendance.lib.enumeration.EM_SECURITYGATE_PERSON_PASS_DIRECTION }
                 */
                ...
                /**
                 *  报警级别,参考枚举{@link vn.attendance.lib.enumeration.EM_SECURITYGATE_ALARM_LEVEL }
                 */
                ...
                /**
                 *  报警位置,参考枚举{@link vn.attendance.lib.enumeration.EM_SECURITYGATE_ALARM_POSITION }
                 */
                // 报警位置
