package vn.attendance.lib.callback.impl;

import com.sun.jna.Pointer;
import vn.attendance.lib.NetSDKLib;
import vn.attendance.lib.callback.BasicVideoStatHeatMapCallBack;
import vn.attendance.lib.callback.fVideoStatHeatMapCallBack;
import vn.attendance.lib.enumeration.EM_HEATMAP_TYPE;
import vn.attendance.module.HeatMapModule;
import vn.attendance.module.entity.HeatMapData;
import vn.attendance.module.entity.HeatMapGrayData;
...
public class DefaultVideoStatHeatMapCallBack extends BasicVideoStatHeatMapCallBack {
   ...
   *     NetSDKLib#CLIENT_GetVideoStatHeatMap(NetSDKLib.LLong, Pointer, Pointer, int)} (NetSDKLib.LLong, Pointer, Pointer,
   *     int)} 对应其出参的nToken字段{@link vn.attendance.lib.structure.NET_OUT_GET_VIDEOSTAT_HEATMAP#nToken}
   * @param type 热度图类型
