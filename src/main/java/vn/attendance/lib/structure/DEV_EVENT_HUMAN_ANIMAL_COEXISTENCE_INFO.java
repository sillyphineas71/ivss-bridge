...
public class DEV_EVENT_HUMAN_ANIMAL_COEXISTENCE_INFO extends NetSDKLib.SdkStructure {
	...
	public int nUTCMS;
	/**
	 * 智能事件所属大类 {@link vn.attendance.lib.enumeration.EM_SCENE_CLASS_TYPE}
	 */
	...
	/**
	 * 事件报警类型 {@link vn.attendance.lib.enumeration.EM_HUMAN_ANIMAL_ALARM_TYPE}
	 */
	public int emAlarmType;
	/**
	 * 场景类型 {@link vn.attendance.lib.enumeration.EM_DETECTION_SCENE_TYPE}
	 */
