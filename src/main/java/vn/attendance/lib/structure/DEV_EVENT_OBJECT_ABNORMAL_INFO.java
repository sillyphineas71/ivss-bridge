...
public class DEV_EVENT_OBJECT_ABNORMAL_INFO extends NetSDKLib.SdkStructure {
	...
	/**
	 * 智能事件所属大类 {@link vn.attendance.lib.enumeration.EM_CLASS_TYPE}
	 */
	...
	/**
	 * 目标类型 {@link vn.attendance.lib.enumeration.EM_ABNORMAL_OBJECT_TYPE}
	 */
	public int emObjectType;
	/**
	 * 异常行为 {@link vn.attendance.lib.enumeration.EM_OBJECT_ABNORMAL_TYPE}
	 */
