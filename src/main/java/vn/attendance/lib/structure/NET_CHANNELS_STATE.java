...
/** 
通道类型 {@link vn.attendance.lib.enumeration.EM_CHANNELS_STATE_TYPE}
*/
public			int					emType;
/** 
通道号
...
public			int					nIndex;
/** 
在线状态 {@link vn.attendance.lib.enumeration.EM_DEV_STATUS}
*/
public			int					emOnlineState;
/** 
报警状态，当emType为EM_CHANNELS_STATE_TYPE_ALARMIN时有效 {@link vn.attendance.lib.enumeration.EM_ZONE_STATUS}
*/
public			int					emAlarmState;
/** 
输出状态，当emType为EM_CHANNELS_STATE_TYPE_ALARMOUT,EM_CHANNELS_STATE_TYPE_SIREN时有效 {@link vn.attendance.lib.enumeration.EM_OUTPUT_STATE}
*/
